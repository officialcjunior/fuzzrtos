...
const uint32_t TableStruct_field_5fmask_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_field_5fmask_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rotobufB\016FieldMaskProtoP\001Z2google.golang"
  ".org/protobuf/types/known/fieldmaskpb\370\001\001"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_field_5fmask_2eproto = {
  false, false, 207, descriptor_table_protodef_field_5fmask_2eproto, "field_mask.proto", 
  &descriptor_table_field_5fmask_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_field_5fmask_2eproto::offsets,
  file_level_metadata_field_5fmask_2eproto, file_level_enum_descriptors_field_5fmask_2eproto, file_level_service_descriptors_field_5fmask_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_field_5fmask_2eproto_getter() {
  return &descriptor_table_field_5fmask_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_field_5fmask_2eproto(&descriptor_table_field_5fmask_2eproto);
namespace google {
namespace protobuf {
...
::PROTOBUF_NAMESPACE_ID::Metadata FieldMask::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_field_5fmask_2eproto_getter, &descriptor_table_field_5fmask_2eproto_once,
      file_level_metadata_field_5fmask_2eproto[0]);
}
